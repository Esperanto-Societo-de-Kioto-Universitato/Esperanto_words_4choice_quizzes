...
def is_mobile_client() -> bool:
    """Request headerのUser-Agentからモバイル端末を判定する。"""
    try:
        ...
        return False
    ua_l = ua.lower()
    return any(token in ua_l for token in MOBILE_UA_TOKENS)
...
def main():
    ...
    mobile_button_height = "54px" if ultra_compact_ui else ("60px" if compact_ui else "80px")
    mobile_button_padding = "4px" if ultra_compact_ui else ("5px" if compact_ui else "8px")
